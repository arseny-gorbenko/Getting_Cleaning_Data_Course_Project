...
Number of observations: 36, that refers to 30 indentifiers of subjects and 6 activity labels

The variable added by me during the cleaning the data:

subject/activity - ether an identifier of the subject who carried out the experiment or activity label



Below is the information on all the rest of the variables that were originaly in datasets
================================================================
...
SO IN COMBINATION YOU GET SUCH VARIABLES AS:
...
Finally only variables measuring means or standard dediations (i.e. having "mean()" or "std()") were extracted.
